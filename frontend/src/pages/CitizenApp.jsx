...
const CitizenApp = () => {
    ...
    const processSOS = (payload, isSilent) => {
        // 🔥 Instant Response & Sound (Image 1/2)
        if (!isSilent) {
    ...
    const handleSOS = () => {
        setSending(true);
        playSOSBeep(); // Trigger on initial hold/tap
        setTimeout(() => {
            ...
            <nav className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest leading-none text-emerald-400">Live</span>
                    </div>
                </div>
            </nav>

            {/* Banner matches Image 1 */}
            {emergencyState && (
                    ...
                    {!emergencyState ? (
                        ...
                        >
                            ...
                            <div className="relative group cursor-pointer" onClick={handleSOS}>
                                ...
                                <div className="relative w-64 h-64 rounded-full bg-red-600 flex flex-col items-center justify-center shadow-[0_0_60px_rgba(239,68,68,0.5)] border-8 border-red-700/50">
                                    {sending ? <Activity className="animate-spin text-white" size={48} /> : (
                                        <>
                                            <span className="text-6xl font-black text-white tracking-tighter drop-shadow-lg italic">SOS</span>
                            ...
                            <div className="mt-16 w-full max-w-sm space-y-4">
                                <div className="bg-[#0D1525] border border-slate-800 p-5 rounded-2xl shadow-2xl">
                                ...
                                <div className="bg-[#0D1525] border border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-2xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-left">
                                            <span className="text-[11px] font-black text-white block uppercase tracking-tight">Silent Distress Mode</span>
                        ...
                        >
                            ...
                            <div className="bg-[#0D1525] border border-slate-800 rounded-3xl p-6 shadow-2xl">
                                ...
                                <div className="bg-blue-600/10 border border-blue-500/30 rounded-2xl p-5 mb-6">
                                    ...
                                    <div className="flex items-center justify-between bg-black/40 p-3 rounded-xl border border-white/5">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-lg text-cyan-400 font-black tracking-[0.2em]">{countdownEta || 9.5} <span className="text-[10px] tracking-widest text-slate-400">MIN</span></span>
                                        </div>
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 gap-3">
                                    <div className="bg-black/40 p-4 rounded-2xl border border-white/5 flex flex-col items-start hover:border-slate-700 transition-all">
                                    ...
                                    <div className="bg-black/40 p-4 rounded-2xl border border-white/5 flex flex-col items-start">
                                        ...
                                        <div className="text-sm font-black text-white tracking-tighter">{sosResponse?.confidence ? `${Math.round(sosResponse.confidence * 100)}%` : '75%'}</div>
                                    </div>
                                    <div className="bg-black/40 p-4 rounded-2xl border border-emerald-500/20 flex flex-col items-start bg-emerald-500/5">
                                ...
                                <button 
                                    ...
                                    className="w-full mt-6 py-4 bg-slate-900 hover:bg-red-900/20 text-slate-500 hover:text-red-500 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] transition-all border border-slate-800 hover:border-red-500/30"
                                >
                                    Cancel Stream
                                </button>
                            </div>
